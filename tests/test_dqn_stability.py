...
def test_layer_norm_matches_single_sample_and_batched_forward() -> None:
...
def test_dqn_replay_loss_is_deterministic_even_with_configured_dropout() -> None:
    torch = pytest.importorskip("torch")
    ...
    torch.manual_seed(123)
    agent = DQNAgent(batch_size=4, min_replay_size=4, dropout_rate=0.75)
