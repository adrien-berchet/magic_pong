...
class TestPhysicsIntegration:
    ...
    def test_paddle_ball_interaction(self):
        ...
        # Paddle 1 is at x = PADDLE_MARGIN, so position ball just before it
        paddle1_x = game_config.PADDLE_MARGIN
        paddle1_y = 300  # Center of field

        # Place ball 50 pixels before the paddle (well away from left wall)
        engine.ball.position.x = paddle1_x + game_config.PADDLE_WIDTH + 5
